...
The `micronutr` package provides tools for calculating and determining select vitamin and mineral deficiencies using R. Currently, `micronutr` has functions for:
